document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getOrCreateErrorElement(field) {
      const wrapper = field.closest('.field, .form-group, .input-wrapper') || field.parentElement;
    ...
    function clearFieldState(field) {
      const wrapper = field.closest('.field, .form-group, .input-wrapper') || field.parentElement;
      wrapper.classList.remove(FIELD_ERROR_CLASS, FIELD_SUCCESS_CLASS);
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target;
      if (field.matches('input, textarea, select') &&
          field.classList.contains(FIELD_ERROR_CLASS.split('--')[0]) ||
          (field.closest('.' + FIELD_ERROR_CLASS))) {
        validateField(field);
      }
    });
  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        if (node.nodeType === 1) {
          if (node.matches && (
            node.matches('.animate-on-scroll, [data-animate], .fade-in, .slide-up, .slide-in')
          )) {
            initScrollAnimations();
          }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מרון פרויקטים ומערכות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4a05541d-7cf7-4489-90d9-16103db17e75',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4a05541d-7cf7-4489-90d9-16103db17e75';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4a05541d-7cf7-4489-90d9-16103db17e75';
